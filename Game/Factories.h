...
namespace Factories
{
	...
	std::shared_ptr<dae::GameObject> QBertFactory(std::weak_ptr<LevelComponent> pLevel, std::weak_ptr<EnemyManager> pEnemyManager, std::shared_ptr<dae::Texture2D> pTexture);
